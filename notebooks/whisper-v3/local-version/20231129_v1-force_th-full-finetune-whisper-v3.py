...
opp_data_train_df, opp_data_test_df = train_test_split(opp_data_train_test_df, stratify=opp_data_train_test_df.symbol, test_size=TEST_RATIO, random_state=SEED)
