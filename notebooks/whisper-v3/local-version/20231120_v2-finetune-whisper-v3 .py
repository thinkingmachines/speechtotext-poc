...
COMMON_VOICE_PATH = DATA_PATH /  "cv-corpus-15.0-2023-09-08" / "th"
...
# Optimize params to train with peft
config = LoraConfig(r=1028, lora_alpha=256, target_modules=["q_proj", "v_proj"], lora_dropout=0.05)
